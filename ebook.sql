...
CREATE TABLE ORDER_LIST (
    OID BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,  -- 自增主鍵
    MID BIGINT NOT NULL,                                 -- 會員 ID
    ORDERTIME TIMESTAMP NOT NULL,                        -- 訂單時間
    PRICE BIGINT NOT NULL,                               -- 訂單總金額
    TNO BIGINT NOT NULL,                                 -- 訂單交易編號
    trainer VARCHAR(128),                                 -- 修改為 VARCHAR(128) 類型
...
------order_list----------
-- T001 負責 3 條訂單
INSERT INTO ORDER_LIST (MID, ORDERTIME, PRICE, TNO, trainer)
VALUES (1, '2021-07-04', 4350, 1, 'T001');  

INSERT INTO ORDER_LIST (MID, ORDERTIME, PRICE, TNO, trainer)
VALUES (2, '2021-04-26', 1500, 2, 'T001');  

INSERT INTO ORDER_LIST (MID, ORDERTIME, PRICE, TNO, trainer)
VALUES (5, '2021-09-15', 1200, 6, 'T001');  

-- T002 負責 1 條訂單
INSERT INTO ORDER_LIST (MID, ORDERTIME, PRICE, TNO, trainer)
VALUES (3, '2021-08-18', 1300, 3, 'T002');  

-- T004 負責 1 條訂單
INSERT INTO ORDER_LIST (MID, ORDERTIME, PRICE, TNO, trainer)
VALUES (4, '2021-05-31', 800, 4, 'T004');  

-- T005 負責 3 條訂單
INSERT INTO ORDER_LIST (MID, ORDERTIME, PRICE, TNO, trainer)
VALUES (2, '2021-12-09', 700, 5, 'T005');  
